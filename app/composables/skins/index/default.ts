export default new Skin('index-default', () => {
	console.log('mounting DEFAULT index');
}, () => {
...
// function handleResize(canvas: HTMLCanvasElement, textCanvas: HTMLCanvasElement, dropCanvas: HTMLCanvasElement, dpi: number, context: CanvasRenderingContext2D) {
